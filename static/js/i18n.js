...
const translations = {
    'AR': {
        ...
        'insights_title': 'ما يُجدي',
        'insights_hint': 'ملخص من آخر المنشورات',
        'insights_placeholder_title': 'استمر في النشر — الرؤى في الطريق!',
        'insights_placeholder_body': 'بعد 5 منشورات منشورة، ستُشاهد ما يُجدي لجمهورك.',
        'insights_default_schedule': 'الجدول الافتراضي الذكي: 3 منشورات يومياً — صباحاً وظهراً ومساءً.',
    ...
    'FR': {
        ...
        'insights_title': "Ce qui fonctionne",
        'insights_hint': 'Résumé des derniers posts',
        'insights_placeholder_title': 'Continuez à publier — les insights arrivent !',
        'insights_placeholder_body': 'Après 5 posts publiés, vous verrez ce qui fonctionne.',
        'insights_default_schedule': 'Défaut intelligent : 3 posts/jour — matin, midi, soir.',
    ...
    'EN': {
        ...
        'insights_title': "What's Working",
        'insights_hint': 'Summary from recent posts',
        'insights_placeholder_title': "Keep posting — insights are on the way!",
        'insights_placeholder_body': "After 5 published posts, you'll see what's working for your audience.",
        'insights_default_schedule': 'Smart default: 3 posts/day — morning, afternoon, and evening.',
