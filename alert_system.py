"""
Alert System - Notifications email en cas d'erreur critique
Utilise SMTP (Gmail/Outlook) pour alertes temps réel
"""
...
def send_email_alert(subject: str, body: str, level: str = AlertLevel.ERROR) -> bool:
    ...
    try:
        ...
        <body style="font-family: Arial, sans-serif; margin: 0; padding: 20px;">
            <div style="background: {color_map.get(level, '#666')}; 
                        padding: 20px; border-radius: 5px 5px 0 0;">
                <h2 style="margin: 0; color: white;">
                    {emoji_map.get(level, '')} Alerte Pipeline Content Factory
                </h2>
            </div>
            ...
            <div style="padding: 20px; background: #f5f5f5; border-radius: 0 0 5px 5px;">
                ...
                <pre style="background: white; padding: 15px; border-left: 4px solid {color_map.get(level, '#666')}; 
...
{body}
        ...
        logger.info(f"✅ Alerte email envoyée: {subject}")
        return True
